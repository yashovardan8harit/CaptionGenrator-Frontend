...
import { Home, LogOut, Settings, User, Copy, Download, RefreshCw, AlertCircle, CheckCircle2, Palette, Sparkles } from "lucide-react";
              ...
              <div className="bg-neutral-800/50 backdrop-blur-sm p-6 rounded-lg border border-neutral-700">
                ...
                <div className="text-sm text-neutral-300 space-y-2 text-left">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <span>Choose your caption style</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-blue-400 font-medium">3.</span>
                    <span>Generate & copy your caption</span>
                  </div>
                </div>
              </div>
            </div>
